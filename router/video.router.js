...
const initRoute = () => {
  ...
  route({ method: HttpMethod.GET, url: '/list/user', action: productController.getByUser });
  route({ method: HttpMethod.GET, url: '/list/user/:id', action: productController.getByIdUser, middelware: [] });
